...
export const knowledgeData: KnowledgeTopic[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Jupiter was discovered by Galileo Galilei in 1610 with a small telescope. The planet has a Great Red Spot which is located at 22 degrees south of Jupiter's equator.",
      "Jupiter was the first planet to form. It moved towards the center during the early times of the Solar System."
    ],
