...
export default function ToolsGrid({ initialTools }: ToolsGridProps) {
  ...
  const totalFilteredCount = Object.values(filteredAndGroupedTools).reduce(
    ...
    <>
      ...
      <div className="flex flex-col gap-4 mb-4">
        <div className="flex justify-between items-center">
            <h3 className="text-lg border-b-4 border-black inline-block pr-4">Available Tools ({totalFilteredCount})</h3>
        </div>
          ...
          {Object.entries(filteredAndGroupedTools).map(([category, tools]) => (
            <div key={category} className="flex flex-col gap-4">
              ...
              {searchQuery ? (
                ...
                // Full grid view when not searching
      ...
      {!searchQuery && (
        <div className="mt-8">
          <AnimatedCard delay={totalFilteredCount * 0.05}>
