...
### 21. Guess the Number
Play a classic high/low number guessing game.
- **Features**: Attempt tracking, high/low feedback, win detection, reset capabilities.
...
- `src/app/guess-the-number/page.tsx`: Guess the Number tool.
