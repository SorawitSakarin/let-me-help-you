...
- **Features**: Attempt tracking, hints for high or low guesses, and success message.
- **Theme**: Fun and simple retro 8-bit style interface.
...
- `src/app/play-guess-the-number/page.tsx`: Guess the Number tool.
