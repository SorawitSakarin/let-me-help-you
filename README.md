...
### 18. Roll a Dice
Roll virtual dice for games, decisions, or fun.
- **Input**: Choose the number of dice to roll (1-6).
- **Features**: Visual representation of the dice, rapid rolling animation, total value display.
- **Theme**: Retro 8-bit style with clean dice designs.
